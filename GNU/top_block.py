...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "mpsk_rolloff")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("mpsk_rolloff")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine( nfilts,nfilts, 1/float(sps),excess_bw, 45*nfilts)
        ...
        # Blocks
        ##################################################
        self._timing_loop_BW_range = Range(0, 200e-3, 10e-3, 62.8e-3, 200)
        self._timing_loop_BW_win = RangeWidget(self._timing_loop_BW_range, self.set_timing_loop_BW, 'Timing: BW', "counter_slider", float)
        self.top_grid_layout.addWidget(self._timing_loop_BW_win)
        self._time_offset_range = Range(999e-3, 1.001, 100e-6, 1.0005, 200)
        ...
        self._noise_volt_range = Range(0, 1, 10e-3, 200e-3, 200)
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4.004, timing_loop_BW, (rrc_taps), 32, 16, 1.5, 1)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(map(int, numpy.random.randint(0, 255, 10000)), True)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine( self.nfilts,self.nfilts, 1/float(self.sps),self.excess_bw, 45*self.nfilts))
